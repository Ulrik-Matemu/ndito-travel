...
export default function KilimanjaroPage() {
  return (
    <div className="p-4 md:p-16 md:pb-0">
        <Navbar />
        <SafariHero photoSrc="/photos/kilimanjaro-hero-nditotravel.jpg" heading="Kilimanjaro Trekking" subheading="Experience the Majesty of Africa's Highest Peak with Ndito Travel" />
