    ...
    return (
        <>
            <div className="p-4 md:p-16 md:pb-0">
                <Navbar />
                <SafariHero photoSrc="/photos/zanzibar-beach-nditotravel-zanzibar.webp" heading="Zanzibar Beach Holiday" subheading="Explore the Pristine Beaches of Zanzibar with Ndito Travel" />
